...
export default function page() {
  return (
    <>
            ...
            <div className='flex flex-col xl:flex-row gap-8 text-white'>
                <div className='flex gap-4 w-full xl:w-6/12 p-4 mt-5 bg-black bg-opacity-75 rounded-xl'>
                    ...
                    <div className='flex-1 flex flex-col justify-between'>
                        ...
                        <div className='p-2 rounded-md bg-amber-600 flex justify-between mt-4'>
                            <div>
                                <p className='text-sm'>Register Now</p>
                                <p>Fall & Spring Semester</p>
                            </div>
                            <h1 className='text-3xl flex items-center'>$20</h1>
                        </div>
                    </div>
                </div>

                <div className='flex gap-4 w-full xl:w-6/12 p-4 mt-5 bg-black bg-opacity-80 rounded-xl'>
                    <div className='rounded-xl w-[300px] h-auto overflow-hidden relative hidden min-[600px]:block'>
        ...
        <section className='mx-auto w-11/12  mt-12 mb-24'>
                ...
                <div className="flex flex-col gap-12 text-left w-full lg:w-8/12 justify-center">
                    <div className='flex flex-col gap-14'>
                        <div>
                            ...
                            <div className='block lg:hidden'><Image className="mb-3" src="/event-gallery/gbmshot1.png" alt="" width={600} height={700} /></div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className='block lg:hidden'><Image className="mb-3" src="/event-gallery/networkevent.png" alt="" width={600} height={700} /></div>
                        </div>
